    ...
    <div className="space-y-6">
      <section className="space-y-4">
        <p className="text-lg leading-relaxed">
          Welcome to teraplayr.com! These terms and conditions outline the rules and regulations for the use of our Website.
        </p>
        <div>
          <div>
            <p>
            ...
            <p>Welcome to teraplayr.com!</p>
            <p>
              These terms and conditions outline the rules and regulations for the
              use of teraplayr.com's Website, located at{" "}
              <a href="https://teraplayr.com">https://teraplayr.com</a>.
            </p>
            <p>
              By accessing this website, we assume you accept these terms and
              conditions. Do not continue to use teraplayr.com if you do not agree
            ...
            <p>
              We employ the use of cookies. By accessing teraplayr.com, you agreed
              to use cookies in agreement with teraplayr.com's Privacy Policy.
            </p>
            <p>
              <strong>License</strong>
            </p>
            <p>
              Unless otherwise stated, teraplayr.com and/or its licensors own the
              intellectual property rights for all material on teraplayr.com. All
              intellectual property rights are reserved. You may access this from
              teraplayr.com for your own personal use subjected to restrictions set
              in these terms and conditions.
            </p>
            <p>You must not:</p>
            <ul>
              <li>Republish material from teraplayr.com</li>
              <li>Sell, rent, or sub-license material from teraplayr.com</li>
              <li>Reproduce, duplicate or copy material from teraplayr.com</li>
              <li>Redistribute content from teraplayr.com</li>
            </ul>
            <p>
            ...
            <p>
              ...
              teraplayr.com does not filter, edit, publish, or review Comments
              prior to their presence on the website. Comments do not reflect the
              views and opinions of teraplayr.com, its agents, and/or affiliates.
              Comments reflect the views and opinions of the person who posts
              them. To the extent permitted by applicable laws, teraplayr.com shall
              not be liable for the Comments or for any liability, damages, or
              expenses caused and/or suffered as a result of any use of and/or
              posting of and/or appearance of the Comments on this website.
            </p>
            <p>
              teraplayr.com reserves the right to monitor all Comments and to
      ...
      <div className="border-t border-gray-200 dark:border-gray-700 pt-6 mt-8">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">
          © 2024 - Present teraplayr.com All rights reserved.
        </p>
      </div>
    </div>
  );
