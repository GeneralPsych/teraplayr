...
const Content = () => {
  return (
    <>
      <div>
        <p className=" p-1 m-2 ">
          <h1 className=" text-4xl">About and Policy for teraplayr.com</h1>
        </p>
        <p className=" p-1 m-2 ">
          <h1>teraplayr.com provides a terabox video downloader</h1>
          At teraplayr.com, accessible from{" "}
          <a href="https://teraplayr.com">https://teraplayr.com</a>, one of our
          main priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by teraplayr.com and how we use it.
        </p>
        <p className=" p-1 m-2 ">
        ...
        <p className=" p-1 m-2 ">
          ...
          shared and/or collect in teraplayr.com. This policy is not applicable
        ...
        <p className=" p-1 m-2 ">
          teraplayr.com follows a standard procedure of using log files. These
        ...
        <p className=" p-1 m-2 ">
          Like any other website, teraplayr.com uses "cookies". These cookies are
        ...
        <p className=" p-1 m-2 ">
          ...
          advertising partners of teraplayr.com.
        </p>
        <p className=" p-1 m-2 ">
          Third-party ad servers or ad networks use technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on teraplayr.com, which are sent
        ...
        <p className=" p-1 m-2 ">
          Note that teraplayr.com has no access to or control over these cookies
        ...
        <p className=" p-1 m-2 ">
          teraplayr.com's Privacy Policy does not apply to other advertisers or
        ...
        <p className=" p-1 m-2 ">
          teraplayr.com does not knowingly collect any Personal Identifiable
